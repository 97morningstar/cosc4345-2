...
// Register Custom Post Type
    function registerPostType() {
        $slug_postype_Staff = 'staffs'; //'Staff'
        $labels = array(
            'name' => _x('Teachers & Staff', 'Post Type General Name', 'childit-core'),
            'singular_name' => _x('Staff', 'Post Type Singular Name', 'childit-core'),
            'menu_name' => __('Staffs', 'childit-core'),
            'name_admin_bar' => __('Staff', 'childit-core'),
            'archives' => __('Item Archives', 'childit-core'),
            'parent_item_colon' => __('Parent Item:', 'childit-core'),
            'all_items' => __('All Staffs', 'childit-core'),
            'add_new_item' => __('Add New Staff', 'childit-core'),
            'add_new' => __('Add New Staff', 'childit-core'),
            'new_item' => __('New Staff Item', 'childit-core'),
            'edit_item' => __('Edit Staff Item', 'childit-core'),
            'update_item' => __('Update Staff Item', 'childit-core'),
            'view_item' => __('View Staff Item', 'childit-core'),
        ...
        $args = array(
            ...
            'show_in_menu' => true,
            'query_var' => true,
            'rewrite' => array('slug' => $slug_postype_Staff),
    ...
    function add_custom_taxonomies() {
        ...
        register_taxonomy('staff', 'staffs', array(
            // Hierarchical taxonomy (like categories)
            'hierarchical' => false,
            // This array of options controls the labels displayed in the WordPress Admin UI
            'labels' => array(
                'name' => _x('Staff Categories', 'childit-core'),
                'singular_name' => _x('Staff Category', 'childit-core'),
