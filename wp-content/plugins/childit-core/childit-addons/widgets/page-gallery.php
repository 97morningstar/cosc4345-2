...
class Page_Gallery extends Widget_Base {
    ...
    public function get_title() {
        return __('Page Gallery ', 'childit-core');
    }
                            ...
                            <div class="grid boxed-gallery-grid">
                                ...
                                while ($query->have_posts()) {
                                    ...
                                    if (has_post_thumbnail()) {
                                        ...
                                        $childit_featured_image_1 = get_the_post_thumbnail_url(get_the_ID(), 'childit_galleries_cont_width');
